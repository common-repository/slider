...
Best free wordpress tool for slideshow. Use responsive slider to create slideshow, gallery and more.

== Description ==

### Check out useful links and demo page, get support or contribute.

* [Wordpress plugin](https://huge-it.com/wordpress-responsive-slider/)
* [Demo](https://huge-it.com/wordpress-responsive-slider-demo/)
* [FAQ](https://huge-it.com/wordpress-responsive-slider-faq/)
* [User Manual](https://huge-it.com/wordpress-responsive-slider-user-manual/)
* [Support](https://huge-it.com/contact-us/)
* [Forum](https://wordpress.org/support/plugin/slider)
* [GitHub Project](https://github.com/Huge-IT/slider)

Responsive Slider is a completely new and advanced way to represent your images in slides. Plugin is the best way to promote your website by creating amazing sliders with beautiful transition effects. So be creative with Huge-IT team, use the WordPress plugin for making your website more competitive. 

Creation of image sliders with this wordpress plugin  is fast and easy. Add your beautiful images into the Responsive Slider, after which give some nice styling and enjoy your modern slider. Helps you to display  unlimited number of images to showcase your amazing works. It is a great solution for photographers, bloggers, web-designers and anyone in WordPress community. 

We have created a light and user-friendly plugin for all categories of users. Responsive back-end design will help to add images and create slides in minutes. The usage of the plugin is very easy, what you need is just to copy and paste the shortcode of the slides into the WordPress post or page, there is no need to deal with any codes.

Huge-IT plugin is designed for everyone who wants to have the most stunning and attractive.  

Plugin is fully responsive and mobile friendly. All your images will appear as beautiful sliders on your WordPress website. You may add unlimited slides , setup arrows, thumbnails, bullets and make further customizations with the Pro version of the plugin. Advanced 2 type shortcode of the plugin allows you to add it in the widget and footer area of your WordPress site. You can use shortcodes with multiple  wordpress plugins. Responsive Slider has been tested with WordPress plugins and themes. 


= Key Features =
 
*  **Fully Responsive and Mobile-Friendly** - Plugin is fully responsive, which means you can open your image on various devices: Smartphones, Tablets, desktop.

*  **Owns 7 Effects** -  Use one of the 7 incredible transition effects to display the image beautifully.

*  **Upload Unlimited Images** - Has advanced Media Library which allows to add various images at the same time, as well as upload as many images as you need into.

*  **Name Your Slides** - Add some creative and interesting names to your images to showcase them.

*  **Image  size** -  Give the most proper size to  the images to fit them more properly, which will promote to represent your projects perfectly.

*  **Autoplay Options** -  Has an autoplay function, this is very useful function for those who want to start the image slider automatically.

*  **Add Title Style** - Do more styling with on the title of your each image.
 
*  **Create Description Style** -  Description Style section suggests choosing different effects and colors for the images.

*  **Social Sharing** - Navigate to your slides and click the Social Sharing option in the menu in order to add 6 social sharing icons. You can pick all 6 or pick couple from available Facebook, Twitter, G+, Pinterest, LinkedIn and Tumblr. Besides that the plugin includes 6 themes for social sharing buttons available.

*  **Advanced Drag and Drop Options** -  Drag and Drop feature with some builder function, which you can use on your admin panel, allows you to change the positions of the text, description, image, button and more.

*  **Custom Element** - Here we may add: Text, Button and Image on the Images. Add desirable styling to the custom elements. 

*  **Custom Element Text** -  Add additional text section and write your desired rich description or other content for your images. 

*  **Custom Element Button** -  Add a button with the link on the images and add suitable styling to the button as well.

*  **Custom Element Image** -  Add images \\ and do suitable styling and customization to the images. You are able to add images from the Media Library.

*  **Arrows** - Suggests various Navigation Arrows to navigate the images smoothly. Select to show navigation arrows images when On Hover or Never.

*  **Thumbnails** - This option will let the users whether or not to open the thumbnails under the main image. Even more you can choose to select thumbnail when hover over the image.
 
*  **How to demonstrate Thumbnails** - In the Thumbnail section of the plugin you can select whether to show the thumbnail by Default or Show All and see on the preview.

*  **Show Bullets** -  When you go to the Bullets section here opens a bunch of features to select. So, choose whether or not to display the bullets images. 

*  **Bullets background color** - Colors: Allows you to change the background or hover color on the bullets and due to preview function to see the result before saving. 

*  **Bullet’s position, orientation and Inline Space** - You can select the position of the bullets on the images. Choose to set bullets Horizontal or Vertical and their size images.
...
*  **Advanced Shortcode** - Plugin has 2 shortcode types: One is prepared to be included on your WordPress post or page and the other is for inserting within your theme.

*  **Preview Feature** - Plugin has a pretty much useful feature,  once you have completed and before you press Save button you can always click on Preview to see how it is looking.


== Installation ==

#### How to install the Pro version plugin?
...
1.  [Demo 1](https://huge-it.com/wordpress-responsive-slider-demo/#plugin_demo_wrapper) - Simple video
11.  [Demo 1](https://huge-it.com/wordpress-responsive-slider-demo/#plugin_demo_wrapper) - Simple video
2.  [Demo 2](https://huge-it.com/wordpress-wordpress-responsive-slider-demo-2-thumbnails/#plugin_demo_wrapper) - Thumbnails
22.  [Demo 2](https://huge-it.com/wordpress-wordpress-responsive-slider-demo-2-thumbnails/#plugin_demo_wrapper) - Thumbnails
3.  [Demo 3](https://huge-it.com/wordpress-responsive-slider-demo-3-no-controls/#plugin_demo_wrapper) - No controls
32.  [Demo 4](https://huge-it.com/wordpress-responsive-slider-demo-4-elements/#plugin_demo_wrapper) - Elements
4.  [Admin Page](https://huge-it.com/wordpress-responsive-slider/)


== Frequently Asked Questions ==


= How to change the position of the elements? =

Simply drag them and place on desired position sample page. Use the small square icon to change the size by dragging up and down
...
= Does your support: videos, last posts, widget integration? =

Unfortunately, the mentioned options are not available in the current version. Yet we are working on major updates, which will include more features, including video support, many effects, layers, social sharing buttons and more.
...
= 2.4.5 =
* 1) We have added functional lightbox to , allowing users to enable lighbox for sliders.
...
= 2.4.3 =
* 1) We have added post functionality, where users can showcase their posts 
...
* 6) We have added additional options for thumbnails
...
* 2) We have added an option to add borders, set colors to borders, determine the size of them. (Pro)
* 3) We have added "Sort Images By" option.

**FIXED BUGS:**

* 1) Activating after click.
...
= 2.3.0 =
**In the series of updates we continue to go through our plugins one by one and fix all technical issues with our code in order to meet the WordPress Coding Standards. These are the major updates that had been implemented to plugin in this new version. We strongly recommend to update the plugin.**
...
* 7) Fixed a bug that caused unexpected outputs when users tried
...
In order to create your first slider press on (+) button  to add a new slider. Name your first and add images to it. Follow the instruction below for more details. 

= General =

In General Options  make general changes. These are the following options you may pay your attention to: 

* **Name:** Title
* **Width(px):** Configure width 
* **Height(px):** Configure height
* **Autoplay:** This will automatically create a slideshow
* **Effect:** Choose the sliding effect
* **Effect Duration:** The speed time of the effect, which was chosen
* **Slide Interval:** The time between each slide, set on miliseconds
* **Title:** Select if you want to have Title, in order to change the style of the title press on “Style”(Styles are for pro version)
* **Description:** Select if you want to have Description, press to “Style” it.(Styles are for pro version)
* **Custom Element:** Add custom button, text or image, generally. Drag the corner of the element block to change it’s size
...
* Add arrows, in order to click on them and change the slides manually. 
...
Thumbnails will allow to showcase image thumbs of your slide, by pressing any thumbnail image you may show it as default.
...
* Show all. Will show all thumbnails no matter how many images there is
* Press Preview to watch the result
* Press SAVE to finalize your work

= Bullets (PRO) =

* Make some custom changes with the bullets/dots
* Show Bullets: Choose to show the dots - Always, on Hover, or Never
